...
module front_back_and_other() {
  translate([left*(front_sheet_width/2+sheet_thickness*2),laser_cutter_depth/2-sheet_height/2-sheet_thickness*2,0]) {
    rotate([0,0,180]) {
      front_sheet();
    }
  }

  translate([right*(front_sheet_width/2+sheet_thickness*2),laser_cutter_depth/2-sheet_height/2-2,0]) {
    rear_sheet();
  }
