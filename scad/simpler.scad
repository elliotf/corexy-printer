...
module y_carriage() {
  rod_bearing_x  = 0; //min_material_thickness*2 + bearing_diam/2;
  ...
  module body() {
    ...
    hull() {
      ...
      translate([bearing_diam/4,0,0]) {
        cube([bearing_diam/2,y_carriage_depth,bearing_diam+min_material_thickness*3],center=true);
      }
